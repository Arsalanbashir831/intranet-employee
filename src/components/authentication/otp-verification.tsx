            ...
            <div className="flex-1 flex items-center justify-center px-8">
              <div className="w-full max-w-sm space-y-6">
                    ...
                    <InputOTPGroup className="flex gap-4">
                      {[0, 1, 2, 3].map((index) => (
                        <InputOTPSlot
                          key={index}
                          index={index}
                          className="w-[80px] h-[67px] !rounded-3xl text-lg text-center border border-gray-300 focus:border-pink-500 focus:ring-pink-500 relative before:content-['*'] before:text-gray-400 before:absolute before:inset-0 before:flex before:items-center before:justify-center data-[state=filled]:before:content-none"
                        />
                      ))}
                    </InputOTPGroup>
                  </InputOTP>
                ...
                <Link href="/reset-password">
                  <Button className="w-full h-12 mb-2 bg-[#D64575] hover:bg-pink-400 text-white rounded-full font-medium text-base">
                    Submit
                  </Button>
                </Link>
