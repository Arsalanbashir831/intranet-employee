...
export function TeamsDetailsCard({ employee }: EmployeeProfileCardProps) {
	...
	const resolved: Employee = {
		...
		id: "1", // not used, but satisfies interface
	};
	...
	return (
		<Card className="border-none mx-auto w-full rounded-lg shadow-[0px_4px_30px_0px_#2E2D740c] p-8">
			{/* Slug Header */}
			...
			{/* About Section */}
			<Separator className="bg-[#E0E2E7] my-6" />
